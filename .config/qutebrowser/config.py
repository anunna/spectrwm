...
## Type: Font
c.fonts.completion.category = 'bold 10pt Roboto Mono'
...
## Type: Font
c.fonts.hints = 'bold 10pt Roboto Mono'

## Font used in the keyhint widget.
## Type: Font
c.fonts.keyhint = '10pt Roboto Mono'

## Font used for error messages.
## Type: Font
c.fonts.messages.error = '10pt Roboto Mono'

## Font used for info messages.
## Type: Font
c.fonts.messages.info = '10pt Roboto Mono'

## Font used for warning messages.
## Type: Font
c.fonts.messages.warning = '10pt Roboto Mono'

## Default monospace fonts. Whenever "monospace" is used in a font
## setting, it's replaced with the fonts listed here.
## Type: Font
#c.fonts.monospace = '"Roboto Mono", "xos4 Terminus", Terminus'

## Font used for prompts.
## Type: Font
c.fonts.prompts = '10pt Roboto Mono'
